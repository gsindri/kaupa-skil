              ...
              {items.map((it, index) => {
                ...
                return (
                  <div
                    ...
                    className={cn(
                      "grid grid-cols-[44px,minmax(0,1fr),112px] md:grid-cols-[48px,minmax(0,1fr),128px] items-center gap-2 rounded-md px-2 py-2 transition focus-visible:ring-2 focus-visible:ring-primary/30",
                      it.quantity === 0 ? "bg-red-50 text-red-700" : "hover:bg-muted/60"
                    )}
                  >
                    <img
