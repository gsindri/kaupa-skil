    ...
    return (
      <button
        ...
        className={cn(
          ...
          'bg-transparent text-[color:var(--ink-dim)] transition-[background-color,color,transform,box-shadow] duration-fast ease-snap motion-reduce:transition-none',
          'hover:bg-white/10 hover:text-[color:var(--ink)]',
        ...
        {...props}
      >
        <span className="text-inherit transition-colors duration-fast ease-snap group-hover:text-[color:var(--ink)]">
          {children}
        </span>
      </button>
    )
