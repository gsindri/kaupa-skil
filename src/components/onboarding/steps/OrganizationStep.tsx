            ...
            <div className="grid gap-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="flex items-center gap-2 text-[13px] text-[color:var(--text-muted)]">
                      <UserCircle2 className="h-4 w-4 text-[color:var(--brand-accent)]" />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="flex items-center gap-2 text-[13px] text-[color:var(--text-muted)]">
                      <Phone className="h-4 w-4 text-[color:var(--brand-accent)]" />
                      Phone
                    </FormLabel>
                    <FormControl>
                      <Input
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="flex items-center gap-2 text-[13px] text-[color:var(--text-muted)]">
                      <MapPinHouse className="h-4 w-4 text-[color:var(--brand-accent)]" />
                      Business address
                    </FormLabel>
                    <FormControl>
                      <Textarea
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="flex items-center gap-2 text-[13px] text-[color:var(--text-muted)]">
                      <Receipt className="h-4 w-4 text-[color:var(--brand-accent)]" />
