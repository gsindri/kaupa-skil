    ...
    <div className="relative min-h-screen">
      ...
      <div
        ...
        style={{
          ...
          marginTop: 'var(--shell-margin-top, 0)',
          minHeight: 'var(--shell-min-height, 100vh)',
          transition: 'margin-top var(--cart-rail-transition), min-height var(--cart-rail-transition)',
        }}
      >
        <a
          href="#main-content"
