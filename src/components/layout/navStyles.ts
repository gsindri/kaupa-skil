...
export const navTextButtonPillClass = [
  ...
  'group-hover:ring-[color:hsl(var(--topbar-ring,var(--ring,0_0%_100%_/_.22)))]',
  'group-focus-visible:ring-[color:hsl(var(--topbar-ring,var(--ring,0_0%_100%_/_.22)))]',
  'group-active:ring-[color:hsl(var(--topbar-ring,var(--ring,0_0%_100%_/_.22)))]',
  'data-[state=open]:ring-[color:hsl(var(--topbar-ring-open,var(--ring-open,0_0%_100%_/_.32)))]',
  'group-data-[state=open]:ring-[color:hsl(var(--topbar-ring-open,var(--ring-open,0_0%_100%_/_.32)))]',
  'data-[active=true]:ring-[color:hsl(var(--topbar-ring,var(--ring,0_0%_100%_/_.22)))]',
  'aria-[current=true]:ring-[color:hsl(var(--topbar-ring,var(--ring,0_0%_100%_/_.22)))]',
  'aria-[current=page]:ring-[color:hsl(var(--topbar-ring,var(--ring,0_0%_100%_/_.22)))]'
].join(' ')
