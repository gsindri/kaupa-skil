export const navTextButtonClass = [
  ...
  'text-[14px] font-medium text-[var(--nav-text-color)]',
  'transition-[color,background-color,transform,outline,box-shadow] duration-150 ease-out',
  'outline-none hover:text-[var(--nav-text-strong-color)] focus-visible:text-[var(--nav-text-strong-color)]',
  'data-[state=open]:font-semibold data-[state=open]:z-[1]',
  'data-[state=open]:text-[var(--nav-text-strong-color)] data-[active=true]:text-[var(--nav-text-strong-color)]',
  'data-[state=open]:[box-shadow:0_12px_32px_-16px_rgba(15,23,42,0.48),_0_0_0_1px_rgba(255,255,255,0.28)]',
  'aria-[current=true]:text-[var(--nav-text-strong-color)] aria-[current=page]:text-[var(--nav-text-strong-color)]'
].join(' ')
...
export const navTextButtonPillClass = [
  ...
  'group-hover:ring-[hsl(var(--topbar-ring))]',
  'group-active:ring-[hsl(var(--topbar-ring))]',
  'data-[state=open]:ring-[hsl(var(--topbar-ring-open))]',
  'group-data-[state=open]:ring-[hsl(var(--topbar-ring-open))]',
  'data-[active=true]:ring-[hsl(var(--topbar-ring))]',
  'aria-[current=true]:ring-[hsl(var(--topbar-ring))]',
  'aria-[current=page]:ring-[hsl(var(--topbar-ring))]'
].join(' ')
...
export const navTextIconClass = [
  ...
  'group-data-[state=open]:text-[var(--nav-text-strong-color)] group-data-[active=true]:text-[var(--nav-text-strong-color)]',
  'group-aria-[current=true]:text-[var(--nav-text-strong-color)] group-aria-[current=page]:text-[var(--nav-text-strong-color)]'
].join(' ')

export const navTextCaretClass = [
  navTextIconClass,
  'text-[var(--nav-text-caret-color)] group-data-[state=open]:rotate-180'
].join(' ')

export const navQuietLinkClass = [
  'group relative inline-flex h-9 min-h-[36px] items-center rounded-full px-2',
  'text-[14px] font-medium text-[var(--ink-dim)] transition-colors duration-150 ease-out',
  'hover:text-[var(--ink)] focus-visible:text-[var(--ink)]',
  'outline-none'
].join(' ')
