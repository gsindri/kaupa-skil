  ...
  return (
    <div
      ...
      style={{
        ...
        ['--ring' as any]: '0 0% 100% / 0.22',
        ['--ring-open' as any]: '0 0% 100% / 0.32',
        ...
        <ContentRail includeRailPadding={false}>
          ...
          <div className="flex min-w-0 flex-1 items-center gap-3">
            ...
            <button
              ...
              className={cn(
                'group inline-flex size-11 items-center justify-center rounded-full border border-white/12 bg-white/10',
                'text-white/80',
                'transition-[background-color,border-color] duration-fast ease-snap',
                'hover:border-white/20 hover:bg-white/15 hover:text-white/90',
            ...
            >
              <span
                aria-hidden="true"
                className="flex size-7 items-center justify-center rounded-full bg-white/10 text-white transition-colors duration-fast ease-snap group-hover:bg-white/15 group-hover:text-white"
              >
                <SearchSoft width={22} height={22} tone={0.25} style={{ color: 'var(--text-on-dark)' }} />
              </span>
            </button>
